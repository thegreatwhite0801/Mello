 ...
 */
    ...
    class FirestoreClass {
        ...
        /**
         * A function to sign in using Firebase and get the user details from Firestore Database.
         */
            ...
            mFireStore.collection(Constants.USERS)
                ...
                .addOnSuccessListener { document ->
                    ...
                    if (document.exists() && document != null) {
                        ...
                        Log.e(activity.javaClass.simpleName, "User document does not exist or is null.")
